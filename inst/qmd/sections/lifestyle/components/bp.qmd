...
#| echo: false
#| results: asis
#| eval: !expr (params$kuadrc_blood_pressure) | (params$bold_blood_pressure) | (params$abcds_blood_pressure) | (params$trcds_blood_pressure)
...
bpft <-
  blood_pressure %>%
  dplyr::select(Date, bpsys, bpdias, bp_cat) %>%
  flextable::flextable() %>%

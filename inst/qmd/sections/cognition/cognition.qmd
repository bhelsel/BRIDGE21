...
# ntgedsd$dsother1 <- NA
# ntgedsd <- rbind(ntgedsd, ntgedsd)

# check_missing <- function(ntgedsd) {
#   missing <- rowSums(is.na(ntgedsd))
#   ncols <- ncol(ntgedsd[, -which(colnames(ntgedsd) == "date")])
#   dates <- ntgedsd$date
#   missing_label <- paste0(
#     round(missing / ncols, 2),
#     "% (n = ",
#     missing,
#     ") missing on ",
#     dates,

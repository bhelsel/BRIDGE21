...
The results in this report were obtained for research purposes for the Clinical Cohort study. Although these research tests alone don't give a full view of your brain health, they are crucial in our quest for knowledge. Remember, we're still piecing together the puzzle of brain science, and your role is essential in this. Some research findings may indicate a higher dementia risk. If you have cognitive symptoms, this information may be helpful in understanding and managing them.
...
params <- extract_params("_variables.yaml")
...
cat(
  strwrap(
    subjinfo[!is.na(subjinfo$final_impression), "final_impression", drop = TRUE],
    width = 100),
  fill = TRUE
  )
